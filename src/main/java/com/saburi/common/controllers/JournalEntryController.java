...
import com.saburi.common.dbaccess.JournalEntryDetailDA;
...
//            this.minSize = 1000;
        ...
        if (CurrentFinacialPeriod.getFinancialPeriodDA() != null) {
            cboFinancialPeriod.setValue(CurrentFinacialPeriod.getFinancialPeriodDA().getDBEntity());
    ...
    protected void save() {
        try {
            ...
            JournalEntryDA journalEntryDA = new JournalEntryDA(financialPeriod, journalID, entryDate, narration, documentType,documentNo, referenceNo, currency, baseAmount,
                    exchangeRate, amount, amountWords, postStatus, JournalTypes.General, EntryModes.Mannual);
