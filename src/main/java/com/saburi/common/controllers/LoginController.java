...
public class LoginController implements Initializable {
        ...
        try {
            ...
            cmiUser.setOnAction(e -> {
                try {
                    ...
                    showDialog("AppUser", "User", 400, 450, btnClose, false);
                    this.setAdefaultRole();
            ...
            cmiLicence.setOnAction(e -> {
                try { 
                    ...
                    showDialog("Licence", "Licence", 400, 450, btnClose, false);
                } catch (IOException ex) {
                    errorMessage(ex);
                }
            });
    ...
    private void setAdefaultRole(){
        try {
            
           new UserRoleDA().createDefaultUserRole();
        } catch (Exception e) {
            errorMessage(e);
        }
...
//            private int success = 1;
            ...
            protected Integer call() {
                setCurrentDBConnection();
                ObservableList<AppUser> appUsers = FXCollections.observableList(new AppUserDA().getAppUsers());
                cmiUser.visibleProperty().bind(Bindings.size(appUsers).lessThan(1));
            ...
            Task<Integer> task = new Task<Integer>() {
                ...
                protected Integer call() throws Exception {
                    try {
                        ...
                        Thread.sleep(500);
                         oAppUserDA = new AppUserDA();
                        updateProgress(50, 100);
                        updateMessage("Cinnection Established...");
                        Thread.sleep(500);
            ...
            Task<Integer> task = new Task<Integer>() {
                ...
                protected Integer call() {
                    try {
                        ...
                        if (oAppUserDA.login(loginID, password)) {
