...
import com.saburi.common.utils.CommonEnums.UnitMeasureUsages;
...
public class MeasureGroupController extends EditController {
    ...
    @FXML
    private TableColumn<MeasureRelationDA, CommonEnums.UnitMeasureUsages> tbcMeasureRelationDefaultUsage;

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        try {
            loadLookupData(cboBaseUnitMeasure, CommonObjectNames.UNITMEASURE);
