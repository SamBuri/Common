...
public class BankAccountDA extends DBAccess {
    ...
    public BankAccountDA(String bankAccountID, String bankAccountName, BankAccountTypes bankAccountType, Currency currency, String accountNo, String bankName, String branchName, ChartAccount postingAccount, String phoneNo, String email, String address, boolean isDefault, double balance) {
        this.bankAccount = new BankAccount(getNextIdHelper(), bankAccountID, bankAccountName, bankAccountType, currency, accountNo, bankName, branchName, postingAccount, phoneNo, email, address, isDefault, balance);
        initialseProprties();
        createSearchColumns();
    }

    public BankAccountDA(String persistenceUnit, String bankAccountID, String bankAccountName, BankAccountTypes bankAccountType, Currency currency, String accountNo, String bankName, String branchName, ChartAccount postingAccount, String phoneNo, String email, String address, boolean isDefault, double balance) {
        super(persistenceUnit);
        this.bankAccount = new BankAccount(getNextIdHelper(), bankAccountID, bankAccountName, bankAccountType, currency, accountNo, bankName, branchName, postingAccount, phoneNo, email, address, isDefault, balance);
        initialseProprties();
        createSearchColumns();
