...
import com.saburi.common.entities.CustomerPostingGroup;import javafx.beans.property.*;
...
public  CustomerPostingGroupDA(String customerPostingGroupID, LookupData customerGroup, ChartAccount receivableAccount, ChartAccount serviceChargeAccount, ChartAccount paymentDiscountAccount){
 this.customerPostingGroup = new CustomerPostingGroup(getNextIdHelper(), customerPostingGroupID, customerGroup, receivableAccount, serviceChargeAccount, paymentDiscountAccount);initialseProprties();
createSearchColumns();
}
public  CustomerPostingGroupDA(String persistenceUnit, String customerPostingGroupID, LookupData customerGroup, ChartAccount receivableAccount, ChartAccount serviceChargeAccount, ChartAccount paymentDiscountAccount){
 super(persistenceUnit);
this.customerPostingGroup = new CustomerPostingGroup(getNextIdHelper(), customerPostingGroupID, customerGroup, receivableAccount, serviceChargeAccount, paymentDiscountAccount);initialseProprties();
createSearchColumns();
}
...
this.customerGroup = customerGroup;this.customerGroupID.set(customerGroup.getId());
...
this.receivableAccount = receivableAccount;this.receivableAccountID.set(receivableAccount.getId());
...
this.serviceChargeAccount = serviceChargeAccount;this.serviceChargeAccountID.set(serviceChargeAccount.getId());
...
this.paymentDiscountAccount = paymentDiscountAccount;this.paymentDiscountAccountID.set(paymentDiscountAccount.getId());
    ...
    public boolean equals(Object o) {
        ...
        return this.getId().equals(customerPostingGroupDA.getId());    } @Override
            public int hashCode
...
if(this.customerGroup!= null){this.customerGroupID.set(customerGroup.getId());
this.customerGroupDisplay.set(customerGroup.getDisplayKey());
}
this.receivableAccount= customerPostingGroup. getReceivableAccount();
if(this.receivableAccount!= null){this.receivableAccountID.set(receivableAccount.getId());
this.receivableAccountDisplay.set(receivableAccount.getDisplayKey());
}
this.serviceChargeAccount= customerPostingGroup. getServiceChargeAccount();
if(this.serviceChargeAccount!= null){this.serviceChargeAccountID.set(serviceChargeAccount.getId());
this.serviceChargeAccountDisplay.set(serviceChargeAccount.getDisplayKey());
}
this.paymentDiscountAccount= customerPostingGroup. getPaymentDiscountAccount();
if(this.paymentDiscountAccount!= null){this.paymentDiscountAccountID.set(paymentDiscountAccount.getId());
this.paymentDiscountAccountDisplay.set(paymentDiscountAccount.getDisplayKey());
}
initCommonProprties();
}
...
return super.find(CustomerPostingGroup.class);
    ...
    public List<DBAccess> get() {
       ...
       if(oCustomerPostingGroup == null) throw new Exception("No Record with id: "+customerPostingGroupID);
