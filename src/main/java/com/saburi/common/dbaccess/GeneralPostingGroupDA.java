...
public class GeneralPostingGroupDA extends DBAccess {
    ...
    public GeneralPostingGroupDA(String generalPostingID, LookupData businessGroup, LookupData itemGroup, ChartAccount salesAccount, ChartAccount salesDiscountAccount, ChartAccount purchasesAccount, ChartAccount directCostAppliedAccount, ChartAccount purchaseDiscountAccount) {
        this.generalPostingGroup = new GeneralPostingGroup(getNextIdHelper(), generalPostingID, businessGroup, itemGroup, salesAccount, salesDiscountAccount, purchasesAccount, directCostAppliedAccount, purchaseDiscountAccount);
        initialseProprties();
        createSearchColumns();
    }

    public GeneralPostingGroupDA(String persistenceUnit, String generalPostingID, LookupData businessGroup, LookupData itemGroup, ChartAccount salesAccount, ChartAccount salesDiscountAccount, ChartAccount purchasesAccount, ChartAccount directCostAppliedAccount, ChartAccount purchaseDiscountAccount) {
        super(persistenceUnit);
        this.generalPostingGroup = new GeneralPostingGroup(getNextIdHelper(), generalPostingID, businessGroup, itemGroup, salesAccount, salesDiscountAccount, purchasesAccount, directCostAppliedAccount, purchaseDiscountAccount);
        initialseProprties();
        createSearchColumns();
    ...
    public GeneralPostingGroup getGeneralPostingGroup(LookupData businessGroup, LookupData itemGroup) throws Exception {
        List<GeneralPostingGroup> generalPostingGroups = super.find(GeneralPostingGroup.class, "businessGroup", businessGroup, "itemGroup", itemGroup);
