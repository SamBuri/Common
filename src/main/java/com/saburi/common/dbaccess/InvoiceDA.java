...
import com.saburi.common.entities.GeneralPostingGroup;
import static com.saburi.common.utils.Utilities.formatNumber;
import com.saburi.common.entities.InvoiceDetails;
import com.saburi.common.entities.JournalEntry;
import com.saburi.common.entities.JournalEntryDetail;
import com.saburi.common.entities.LookupData;
import com.saburi.common.entities.SaleOrderDetail;
...
import com.saburi.common.utils.AccountAmount;
import com.saburi.common.utils.CommonEnums.AccountActions;
import com.saburi.common.utils.CommonEnums.AccountGroups;
import com.saburi.common.utils.CommonEnums.DocumentTypes;
import com.saburi.common.utils.CommonEnums.EntryModes;
import com.saburi.common.utils.CommonEnums.JournalTypes;
import com.saburi.common.utils.CommonEnums.PostStatus;
import com.saburi.common.utils.CommonOptionKeys;
...
public class InvoiceDA extends DBAccess {
    ...
    public boolean save() throws Exception {
        ...
        Map<List<? extends DBEntity>, CommonEnums.Rights> map = new HashMap<>();
        List<Invoice> invoices = new ArrayList<>();
        List<JournalEntry> journalEntries = new ArrayList<>();
        JournalEntry journalEntry = this.makeJournalEntries();
        journalEntries.add(journalEntry);
        invoices.add(invoice);
        map.put(invoices, CommonEnums.Rights.Create);
        map.put(journalEntries, CommonEnums.Rights.Create);
        ...
        if (invoice.getInvoiceType().equals(InvoiceTypes.Ordered)) {
            ...
            invoice.getInvoiceDetails().forEach(inv -> {
                ...
                sODetail.setInvoiceStatus(CommonEnums.InvoiceStatus.Invoiced);
                saleOrderDetails.add(sODetail);
            });
            map.put(saleOrderDetails, CommonEnums.Rights.Update);
        }
        super.processBatchList(map);
        if (OptionsDA.getBooleanOptionValue(CommonOptionKeys.ENABLE_AUTO_GENERAL_LEDGER_POSTING)) {
    ...
    public JournalEntry makeJournalEntries() throws Exception {
        ...
        FinancialPeriod financialPeriod = CurrentFinacialPeriod.getFinancialPeriodDA().getFinancialPeriod();
        ...
        journalEntryDetails.add(new JournalEntryDetail(AccountGroups.Customer, journalEntry, billToCustomer.getCustomerID(),
                billToCustomer.getDisplayKey(), CommonEnums.AccountTypes.Asset, AccountActions.Debit, 1, 1, invoice.getAmount(),
                narration, null));
        ...
        groupedSalesAccounts.entrySet().forEach((entry) -> {
            journalEntryDetails.add(new JournalEntryDetail(AccountGroups.COA, journalEntry, entry.getKey().getAccountID(),
                    entry.getKey().getAccountName(), CommonEnums.AccountTypes.Income, AccountActions.Credit, 1, 1, entry.getValue(),
                    narration, null));
        });

        groupedDiscAccounts.entrySet().forEach((entry) -> {
            journalEntryDetails.add(new JournalEntryDetail(AccountGroups.COA, journalEntry, entry.getKey().getAccountID(),
                    entry.getKey().getAccountName(), CommonEnums.AccountTypes.Expense, AccountActions.Debit, 1, 1, entry.getValue(),
                    narration, null));
        });
