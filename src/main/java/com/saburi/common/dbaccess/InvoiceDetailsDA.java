...
import com.saburi.common.entities.MeasureRelation;
...
public class InvoiceDetailsDA extends DBAccess {
    ...
    public void setItem(Item item) {
        ...
        Optional<MeasureRelation> invoiceMeasureRelation = measureRelations.stream()
                ...
                .filter((p) -> p.getDefaultUsage().equals(CommonEnums.UnitMeasureUsages.Invoicing))
                .findFirst();
    ...
    public void setInvoiceType(CommonEnums.InvoiceTypes invoiceType) {
    ...
    private void createSearchColumns() {
        ...
        this.searchColumns.add(new SearchColumn("unitMeasure", "UnitMeasure", this.unitMeasure.get(), SearchDataTypes.STRING));
        this.searchColumns.add(new SearchColumn("measureSize", "MeasureSize", this.measureSize.get(), SearchDataTypes.NUMBER));
