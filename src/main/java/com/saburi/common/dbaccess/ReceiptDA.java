...
import com.saburi.common.entities.ReceiptInvoice;
...
public class ReceiptDA extends DBAccess {
    ...
    private void createSearchColumns() {
        ...
        this.searchColumns.add(new SearchColumn("receiptDate", "Receipt Date", this.receiptDate.get(), SearchDataTypes.STRING));
        ...
        this.searchColumns.add(new SearchColumn("totalBill", "Total Bill", this.totalBill.get(), SearchDataTypes.NUMBER));
        this.searchColumns.add(new SearchColumn("amountTered", "Amount Tendered", this.amountTered.get(), SearchDataTypes.NUMBER));
        ...
        this.searchColumns.add(new SearchColumn("changeGiven", "Change Given", this.changeGiven.get(), SearchDataTypes.NUMBER));
