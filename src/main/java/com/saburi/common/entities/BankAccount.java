...
public class BankAccount extends DBEntity {
    ...
    public BankAccount(int idHelper, String bankAccountID, String bankAccountName, BankAccountTypes bankAccountType, Currency currency, String accountNo, String bankName, String branchName, ChartAccount postingAccount, String phoneNo, String email, String address, boolean isDefault, double balance) {
