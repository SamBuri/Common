...
@Column(length = 20, updatable = false)private String customerPostingGroupID;
@NotNull(message =  "The field: Customer Group cannot be null")
@OneToOne
@JoinColumn(name = "customerGroupID",foreignKey = @ForeignKey(name = "fkCustomerGroupIDCustomerPostingGroup"))private LookupData customerGroup;
@OneToOne
@JoinColumn(name = "receivableAccountID",foreignKey = @ForeignKey(name = "fkReceivableAccountIDCustomerPostingGroup"))private ChartAccount receivableAccount;
@OneToOne
@JoinColumn(name = "serviceChargeAccountID",foreignKey = @ForeignKey(name = "fkServiceChargeAccountIDCustomerPostingGroup"))private ChartAccount serviceChargeAccount;
@OneToOne
@JoinColumn(name = "paymentDiscountAccountID",foreignKey = @ForeignKey(name = "fkPaymentDiscountAccountIDCustomerPostingGroup"))private ChartAccount paymentDiscountAccount;

public CustomerPostingGroup(){
}
public  CustomerPostingGroup(int idHelper,String customerPostingGroupID,LookupData customerGroup,ChartAccount receivableAccount,ChartAccount serviceChargeAccount,ChartAccount paymentDiscountAccount){
