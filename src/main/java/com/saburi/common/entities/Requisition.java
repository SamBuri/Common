...
public class Requisition extends DBEntity{
...
@OneToOne
@JoinColumn(name = "itemGroupID",foreignKey = @ForeignKey(name = "fkItemGroupIDRequisition"))private LookupData itemGroup;

public Requisition(){
}
public  Requisition(int idHelper,String requisitionID,LocalDate requistionDate,OpenStatus status,LookupData itemGroup){
...
this.itemGroup = itemGroup;
 ...
 @Override
    public boolean equals(Object o) {
        ...
        return this.getId().equals(requisition.getId());
    }
    @Override
    public int hashCode() {
