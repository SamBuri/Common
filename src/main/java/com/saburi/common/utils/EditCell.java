...
public class EditCell <S, T> extends TextFieldTableCell<S, T> {
	...
	public static <S> Callback<TableColumn<S, String>, TableCell<S, String>> StringTableColumn() {
		return forTableColumn(new DefaultStringConverter());
	}
        
        public static <S> Callback<TableColumn<S, Integer>, TableCell<S, Integer>> IntegerTableColumn() {
		return forTableColumn(new IntegerStringConverter());
	}
        
        public static <S> Callback<TableColumn<S, Double>, TableCell<S, Double>> DoubleTableColumn() {
		return forTableColumn(new DoubleStringConverter());
	}
        
         public static <S> Callback<TableColumn<S, Float>, TableCell<S, Float>> FloatTableColumn() {
		return forTableColumn(new FloatStringConverter());
	}
       
         public static <S> Callback<TableColumn<S, Boolean>, TableCell<S, Boolean>> BooleanTableColumn() {
