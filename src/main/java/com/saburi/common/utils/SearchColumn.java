...
//                                Double d = getDouble(value, "Search Value");
    ...
    public Predicate<DBAccess> lengthLessPrediacte(SearchColumn selectedSearchColumn, int value) {
    ...
    public Predicate<DBAccess> lengthLessEqualPredicate(SearchColumn selectedSearchColumn, int value) {
    ...
    public Predicate<DBAccess> lengthLessGreaterPredicate(SearchColumn selectedSearchColumn, int value) {
